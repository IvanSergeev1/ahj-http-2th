[Ссылка на проект](https://ivansergeev1.github.io/ahj-http-2th)

[![Build status](https://ci.appveyor.com/api/projects/status/nilsotka5sdk653g?svg=true)](https://ci.appveyor.com/project/IvanSergeev1/ahj-http-2th)
...
![](https://github.com/QueenArizona/ahj-homeworks/blob/master/http/pic/helpdesk.png)

Модальное окно добавления нового тикета (вызывается по кнопке "Добавить тикет" в правом верхнем углу):

![](https://github.com/QueenArizona/ahj-homeworks/blob/master/http/pic/helpdesk-2.png)

Модальное окно редактирования существующего тикета (вызвается по кнопке с иконкой "✎" - карандашик):

![](https://github.com/QueenArizona/ahj-homeworks/blob/master/http/pic/helpdesk-3.png)

Модальное окно подтверждения удаления (вызывается по кнопке с иконкой "x" - крестик):

![](https://github.com/QueenArizona/ahj-homeworks/blob/master/http/pic/helpdesk-4.png)

Для просмотра деталей тикета нужно нажать на самом тикете (но не на контролах - сделано, редактировать или удалить):

![](https://github.com/QueenArizona/ahj-homeworks/blob/master/http/pic/helpdesk-5.png)
